...
<form action="http://localhost/spring_mvc/mybatis/day0527/dynamicTrim.do" method="get" id="frm">
	<label>입력</label>
	사원번호<input type="text" name="empno" class="inputBox" id="empno"><br/>
	부서번호<input type="text" name="deptno" class="inputBox" id="deptno"><br/>
	직무<input type="text" name="job" class="inputBox"><br/>
	<input type="button" value="전송" class="btn btn-success" id="btn"/>
</form>


<strong>Trim 검색결과</strong>
