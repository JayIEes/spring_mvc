...
<body>
<div>
<a href="http://localhost/spring_mvc/mybatis/day0526/dynamicIf.do">전체사원검색</a>
<c:forEach var="job" items="${jobs}">
<a href="http://localhost/spring_mvc/mybatis/day0526/dynamicIf.do?job=${job}"><c:out value="${job}"/></a>
</c:forEach>
</div>
...
<strong><c:out value="${param.job}"/> 검색결과</strong>
